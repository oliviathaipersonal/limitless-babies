...
import { speakBridge, stopSpeech, isNativePlatformSync, getNativeVoices } from "./native-speech.js";
  ...
  return (
    <div style={{marginTop:14,padding:"12px 14px",background:"#F0FFF4",border:"1px solid #BBF7D0",borderRadius:10}}>
      ...
      <button onClick={() => setShowAllVoices(s => !s)}
        ...
        <span style={{flex:1}}>{showAllVoices ? "Hide" : "Show"} all voices on this device ({voices.length})</span>
