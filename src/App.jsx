  ...
  try {
    ...
    for (const child of kids) {
      if (Array.isArray(child.languages)) {
        const newLangs = child.languages.map(l => LEGACY_CN_MAP[l] || l);
        if (newLangs.some((l, i) => l !== child.languages[i])) {
      ...
      if (child.position && typeof child.position === "object") {
        for (const oldKey of Object.keys(LEGACY_CN_MAP)) {
          if (child.position[oldKey]) {
            child.position[LEGACY_CN_MAP[oldKey]] = child.position[oldKey];
...
// by the (mock) "subscribe" button in PremiumUpsell. Free tier includes all
// languages (Duolingo-style). Premium unlocks: multi-child accounts, custom
// family photo libraries, and parent profile features.
function getPremium() {
  try {
      ...
      <div style={{flex:1,overflowY:"auto"}}>
        ...
        <div style={{padding:"24px 22px 12px",background:"linear-gradient(180deg,#FFF0F1 0%,#fff 100%)"}}>
          ...
          <p style={{fontFamily:"Nunito,sans-serif",fontWeight:800,fontSize:13,color:RED,textAlign:"center",margin:"4px 0 0"}}>
            {reason === "multi-child" && "Free covers one child. Premium adds up to 4."}
            {reason === "custom-photos" && "Custom family photos are a Premium feature."}
            {reason === "parent-profile" && "Parent profile is a Premium feature."}
            {(!reason || reason === "general") && "Multi-child, custom family photos, and exclusive parent content."}
          </p>
        </div>
        ...
        <div style={{padding:"18px 22px"}}>
          ...
          <p style={{fontFamily:"Nunito,sans-serif",fontWeight:700,fontSize:10,color:"#999",textAlign:"center",marginTop:14,lineHeight:1.5}}>
            ✨ All 100+ languages are <strong style={{color:RED}}>free, always</strong>. Premium adds extra support, content, and family features.
          </p>
        </div>
        ...
        <div style={{padding:"6px 22px"}}>
          ...
          <div style={{display:"flex",gap:8,marginBottom:14}}>
            <button onClick={()=>setTier("single")}
              ...
              <div style={{fontWeight:800,fontSize:13,color:tier==="single"?RED:"#111"}}>{t("Single child")}</div>
