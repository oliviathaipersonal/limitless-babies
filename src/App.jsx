              ...
              return (
                <div style={{marginBottom:22,background:"linear-gradient(135deg,#FFF0F1 0%,#FFE4E6 100%)",border:`2px solid ${RED}`,borderRadius:18,padding:"16px 18px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:6}}>
                    ...
                    <div style={{flex:1}}>
                      <div style={{fontFamily:"'Fredoka One',cursive",fontSize:18,color:RED,lineHeight:1.1}}>{milestone.level}</div>
                      <div style={{fontFamily:"Nunito,sans-serif",fontWeight:700,fontSize:11,color:"#888",marginTop:2}}>{milestone.description}</div>
                    </div>
                    <div style={{textAlign:"right"}}>
                      <div style={{fontFamily:"'Fredoka One',cursive",fontSize:20,color:RED,lineHeight:1}}>~{vocab}</div>
  ...
  return (
    <div style={{minHeight:"100vh",background:"#fff",display:"flex",flexDirection:"column"}}>
      ...
      <div onClick={advance}
        ...
        <div style={{fontSize:40,fontFamily:"'Fredoka One',cursive",color:RED,textAlign:"center",lineHeight:1.2,letterSpacing:.5,maxWidth:340}}>
          {page.text}
        </div>
