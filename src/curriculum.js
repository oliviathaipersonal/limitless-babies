...
export const KNOWLEDGE_MONTH1 = [
  { id:"kset1-epic-historical-women", name:"Epic Historical Women", items:[
    { id:"cleopatra", photoSeed:"cleopatra", facts:[null,null,null] },
    { id:"joan_of_arc", photoSeed:"joan_of_arc", facts:[null,null,null] },
    { id:"queen_victoria", photoSeed:"queen_victoria", facts:[null,null,null] },
    { id:"amelia_earhart", photoSeed:"amelia_earhart", facts:[null,null,null] },
    { id:"marie_curie", photoSeed:"marie_curie", facts:[null,null,null] },
  ]},
  { id:"kset2-flags-of-europe", name:"Flags of Europe", items:[
    { id:"italy_flag", photoSeed:"italy_flag", facts:[null,null,null] },
    { id:"france_flag", photoSeed:"france_flag", facts:[null,null,null] },
    { id:"germany_flag", photoSeed:"germany_flag", facts:[null,null,null] },
    { id:"spain_flag", photoSeed:"spain_flag", facts:[null,null,null] },
    { id:"uk_flag", photoSeed:"uk_flag", facts:[null,null,null] },
  ]},
  { id:"kset3-landmarks", name:"Landmarks", items:[
    { id:"eiffel_tower", photoSeed:"eiffel_tower", facts:[null,null,null] },
    { id:"great_wall", photoSeed:"great_wall", facts:[null,null,null] },
    { id:"statue_liberty", photoSeed:"statue_liberty", facts:[null,null,null] },
    { id:"pyramid", photoSeed:"pyramid", facts:[null,null,null] },
    { id:"taj_mahal", photoSeed:"taj_mahal", facts:[null,null,null] },
  ]},
  { id:"kset4-dog-breeds", name:"Dog Breeds", items:[
    { id:"labrador", photoSeed:"labrador", facts:[null,null,null] },
    { id:"poodle", photoSeed:"poodle", facts:[null,null,null] },
    { id:"bulldog", photoSeed:"bulldog", facts:[null,null,null] },
    { id:"husky", photoSeed:"husky", facts:[null,null,null] },
    { id:"corgi", photoSeed:"corgi", facts:[null,null,null] },
  ]},
  { id:"kset5-sport-balls", name:"Sport Balls", items:[
    { id:"soccer_ball", photoSeed:"soccer_ball", facts:[null,null,null] },
    { id:"basketball", photoSeed:"basketball", facts:[null,null,null] },
    { id:"baseball", photoSeed:"baseball", facts:[null,null,null] },
    { id:"tennis_ball", photoSeed:"tennis_ball", facts:[null,null,null] },
    { id:"football", photoSeed:"football", facts:[null,null,null] },
  ]},
  { id:"kset6-symbols-of-america", name:"Symbols of America", items:[
    { id:"bald_eagle", photoSeed:"bald_eagle", facts:[null,null,null] },
    { id:"liberty_bell", photoSeed:"liberty_bell", facts:[null,null,null] },
    { id:"american_flag", photoSeed:"american_flag", facts:[null,null,null] },
    { id:"white_house", photoSeed:"white_house", facts:[null,null,null] },
    { id:"mt_rushmore", photoSeed:"mt_rushmore", facts:[null,null,null] },
  ]},
  { id:"kset7-flags-of-asia", name:"Flags of Asia", items:[
    { id:"japan_flag", photoSeed:"japan_flag", facts:[null,null,null] },
    { id:"china_flag", photoSeed:"china_flag", facts:[null,null,null] },
    { id:"korea_flag", photoSeed:"korea_flag", facts:[null,null,null] },
    { id:"india_flag", photoSeed:"india_flag", facts:[null,null,null] },
    { id:"vietnam_flag", photoSeed:"vietnam_flag", facts:[null,null,null] },
  ]},
  { id:"kset8-big-cats", name:"Big Cats", items:[
    { id:"lion", photoSeed:"lion", facts:[null,null,null] },
    { id:"tiger", photoSeed:"tiger", facts:[null,null,null] },
    { id:"leopard", photoSeed:"leopard", facts:[null,null,null] },
    { id:"cheetah", photoSeed:"cheetah", facts:[null,null,null] },
    { id:"jaguar", photoSeed:"jaguar", facts:[null,null,null] },
  ]},
  { id:"kset9-kinds-of-automobiles", name:"Kinds of Automobiles", items:[
    { id:"sedan", photoSeed:"sedan", facts:[null,null,null] },
    { id:"suv", photoSeed:"suv", facts:[null,null,null] },
    { id:"sportscar", photoSeed:"sportscar", facts:[null,null,null] },
    { id:"pickup", photoSeed:"pickup", facts:[null,null,null] },
    { id:"convertible", photoSeed:"convertible", facts:[null,null,null] },
  ]},
  { id:"kset10-inspirational-people", name:"Inspirational People", items:[
    { id:"mlk", photoSeed:"mlk", facts:[null,null,null] },
    { id:"gandhi", photoSeed:"gandhi", facts:[null,null,null] },
    { id:"mandela", photoSeed:"mandela", facts:[null,null,null] },
    { id:"mother_teresa", photoSeed:"mother_teresa", facts:[null,null,null] },
    { id:"einstein", photoSeed:"einstein", facts:[null,null,null] },
  ]},
  { id:"kset11-african-animals", name:"African Animals", items:[
    { id:"elephant", photoSeed:"elephant", facts:[null,null,null] },
    { id:"giraffe", photoSeed:"giraffe", facts:[null,null,null] },
    { id:"zebra", photoSeed:"zebra", facts:[null,null,null] },
    { id:"lion", photoSeed:"lion", facts:[null,null,null] },
    { id:"rhinoceros", photoSeed:"rhinoceros", facts:[null,null,null] },
  ]},
  { id:"kset12-international-cuisine", name:"International Cuisine", items:[
    { id:"sushi", photoSeed:"sushi", facts:[null,null,null] },
    { id:"pizza", photoSeed:"pizza", facts:[null,null,null] },
    { id:"tacos", photoSeed:"tacos", facts:[null,null,null] },
    { id:"curry", photoSeed:"curry", facts:[null,null,null] },
    { id:"croissant", photoSeed:"croissant", facts:[null,null,null] },
  ]},
];

export const KNOWLEDGE_MONTH2 = [
  { id:"kset1-historic-landmarks", name:"Historic Landmarks", items:[
    { id:"colosseum", photoSeed:"colosseum", facts:[null,null,null] },
    { id:"acropolis", photoSeed:"acropolis", facts:[null,null,null] },
    { id:"machu_picchu", photoSeed:"machu_picchu", facts:[null,null,null] },
    { id:"angkor_wat", photoSeed:"angkor_wat", facts:[null,null,null] },
    { id:"stonehenge", photoSeed:"stonehenge", facts:[null,null,null] },
  ]},
  { id:"kset2-technology", name:"Technology", items:[
    { id:"smartphone", photoSeed:"smartphone", facts:[null,null,null] },
    { id:"laptop", photoSeed:"laptop", facts:[null,null,null] },
    { id:"headphones", photoSeed:"headphones", facts:[null,null,null] },
    { id:"drone", photoSeed:"drone", facts:[null,null,null] },
    { id:"smartwatch", photoSeed:"smartwatch", facts:[null,null,null] },
  ]},
  { id:"kset3-sports", name:"Sports", items:[
    { id:"basketball", photoSeed:"basketball", facts:[null,null,null] },
    { id:"soccer", photoSeed:"soccer", facts:[null,null,null] },
    { id:"tennis", photoSeed:"tennis", facts:[null,null,null] },
    { id:"golf", photoSeed:"golf", facts:[null,null,null] },
    { id:"surfing", photoSeed:"surfing", facts:[null,null,null] },
  ]},
  { id:"kset4-presidents-of-the-usa", name:"Presidents of the USA", items:[
    { id:"washington", photoSeed:"washington", facts:[null,null,null] },
    { id:"lincoln", photoSeed:"lincoln", facts:[null,null,null] },
    { id:"jefferson", photoSeed:"jefferson", facts:[null,null,null] },
    { id:"roosevelt", photoSeed:"roosevelt", facts:[null,null,null] },
    { id:"kennedy", photoSeed:"kennedy", facts:[null,null,null] },
  ]},
  { id:"kset5-kinds-of-transport", name:"Kinds of Transport", items:[
    { id:"airplane", photoSeed:"airplane", facts:[null,null,null] },
    { id:"ship", photoSeed:"ship", facts:[null,null,null] },
    { id:"train", photoSeed:"train", facts:[null,null,null] },
    { id:"helicopter", photoSeed:"helicopter", facts:[null,null,null] },
    { id:"bicycle", photoSeed:"bicycle", facts:[null,null,null] },
  ]},
  { id:"kset6-flags-of-the-americas", name:"Flags of the Americas", items:[
    { id:"usa_flag", photoSeed:"usa_flag", facts:[null,null,null] },
    { id:"canada_flag", photoSeed:"canada_flag", facts:[null,null,null] },
    { id:"mexico_flag", photoSeed:"mexico_flag", facts:[null,null,null] },
    { id:"brazil_flag", photoSeed:"brazil_flag", facts:[null,null,null] },
    { id:"argentina_flag", photoSeed:"argentina_flag", facts:[null,null,null] },
  ]},
  { id:"kset7-organs", name:"Organs", items:[
    { id:"heart", photoSeed:"heart", facts:[null,null,null] },
    { id:"brain", photoSeed:"brain", facts:[null,null,null] },
    { id:"lungs", photoSeed:"lungs", facts:[null,null,null] },
    { id:"liver", photoSeed:"liver", facts:[null,null,null] },
    { id:"kidneys", photoSeed:"kidneys", facts:[null,null,null] },
  ]},
  { id:"kset8-occupations", name:"Occupations", items:[
    { id:"doctor", photoSeed:"doctor", facts:[null,null,null] },
    { id:"teacher", photoSeed:"teacher", facts:[null,null,null] },
    { id:"architect", photoSeed:"architect", facts:[null,null,null] },
    { id:"chef", photoSeed:"chef", facts:[null,null,null] },
    { id:"scientist", photoSeed:"scientist", facts:[null,null,null] },
  ]},
  { id:"kset9-musical-instruments", name:"Musical Instruments", items:[
    { id:"piano", photoSeed:"piano", facts:[null,null,null] },
    { id:"guitar", photoSeed:"guitar", facts:[null,null,null] },
    { id:"violin", photoSeed:"violin", facts:[null,null,null] },
    { id:"drums", photoSeed:"drums", facts:[null,null,null] },
    { id:"flute", photoSeed:"flute", facts:[null,null,null] },
  ]},
  { id:"kset10-fruit", name:"Fruit", items:[
    { id:"mango", photoSeed:"mango", facts:[null,null,null] },
    { id:"pineapple", photoSeed:"pineapple", facts:[null,null,null] },
    { id:"kiwi", photoSeed:"kiwi", facts:[null,null,null] },
    { id:"dragonfruit", photoSeed:"dragonfruit", facts:[null,null,null] },
    { id:"papaya", photoSeed:"papaya", facts:[null,null,null] },
  ]},
  { id:"kset11-exotic-birds", name:"Exotic Birds", items:[
    { id:"peacock", photoSeed:"peacock", facts:[null,null,null] },
    { id:"parrot", photoSeed:"parrot", facts:[null,null,null] },
    { id:"flamingo", photoSeed:"flamingo", facts:[null,null,null] },
    { id:"toucan", photoSeed:"toucan", facts:[null,null,null] },
    { id:"hornbill", photoSeed:"hornbill", facts:[null,null,null] },
  ]},
  { id:"kset12-african-countries", name:"African Countries", items:[
    { id:"egypt", photoSeed:"egypt", facts:[null,null,null] },
    { id:"kenya", photoSeed:"kenya", facts:[null,null,null] },
    { id:"nigeria", photoSeed:"nigeria", facts:[null,null,null] },
    { id:"morocco", photoSeed:"morocco", facts:[null,null,null] },
    { id:"southafrica", photoSeed:"southafrica", facts:[null,null,null] },
  ]},
];
