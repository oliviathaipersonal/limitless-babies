...
export const EXTRA_TRANSLATIONS = {
  ...
  "seagull": { Spanish:"gaviota", French:"mouette", German:"möwe", Italian:"gabbiano", Portuguese:"gaivota", "Portuguese (Brazil)":"gaivota", "Chinese (Mandarin)":"海鸥", "Chinese (Cantonese)":"海鷗", Japanese:"カモメ", Korean:"갈매기", Vietnamese:"hải âu" },
  ...
  "home": { "Spanish":"casa", "French":"maison", "German":"zuhause", "Italian":"casa", "Portuguese":"casa", "Portuguese (Brazil)":"casa", "Russian":"дом", "Chinese (Mandarin)":"家", "Chinese (Cantonese)":"屋", "Japanese":"いえ", "Korean":"집", "Hebrew":"בית", "Arabic":"بيت", "Hindi":"घर", "Vietnamese":"nhà", "Thai":"บ้าน", "Turkish":"ev" },
...
export const COUPLETS_MONTH2 = [
  // Photo URLs sourced from Olivia's curated spreadsheet (May 2026 update).
  // Items without photoUrl fall back to the single-word photo (WORD_PHOTO_URLS)
  // or family-photo upload, depending on word and parent setup.
  { id:"set1-colors-and-fruits", name:"Colors and Fruits", items:[
    { words:["red","apple"],     photoUrl:"https://cdn.pixabay.com/photo/2016/09/29/08/33/apple-1702316_1280.jpg" },
    { words:["yellow","banana"], photoUrl:"https://media.istockphoto.com/id/1395906587/photo/two-perfect-ripe-yellow-bananas-isolated-on-white-background.jpg?s=612x612&w=0&k=20&c=wbr6Rm02OXJvYSGxcSrLR5AIIl-vBy4lnyLTjIe-arc=" },
    { words:["orange","orange"], photoUrl:"https://media.istockphoto.com/id/2124102567/photo/orange-fruit-with-leaf.jpg?s=612x612&w=0&k=20&c=TUXQZs76_KNXdbffr6B9Jm74SQ-KbXAaikxTE78Qy6o=" },
    { words:["purple","grapes"], photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/044/868/984/small/fruits-purple-grape-with-leaves-isolated-on-a-transparent-background-png.png" },
    { words:["green","pear"],    photoUrl:"https://media.istockphoto.com/id/1391893617/photo/pear-fruit-on-white.jpg?s=612x612&w=0&k=20&c=MCTbol4sCGjPXZr6QshUNi_KtluG6meN-mALzaddcuU=" },
  ]},
  // Set 2 — "tall daddy" → "cool daddy" (May 2026 content update).
  // Family items render uploaded family photos when available, falling back
  // to the kinship emoji.
  ...
  { id:"set3-actions-and-animals", name:"Actions and Animals", items:[
    { words:["running","dog"],    photoUrl:"https://thumbs.dreamstime.com/b/happy-dog-running-full-speed-mixed-breed-34989996.jpg" },
    { words:["flying","bird"],    photoUrl:"https://t4.ftcdn.net/jpg/08/89/00/87/360_F_889008734_Jt9O8zCFJMmKaQIJx2l1oXIXDgwzxwvp.jpg" },
    { words:["jumping","cat"],    photoUrl:"https://t3.ftcdn.net/jpg/00/92/07/16/360_F_92071640_JofRv8mOeqK5KRD4ue0jM83SbdnirJx0.jpg" },
    { words:["swimming","fish"],  photoUrl:"https://thumbs.dreamstime.com/b/two-golden-fish-swimming-crystal-clear-water-ai-generated-357935409.jpg" },
    { words:["hopping","rabbit"], photoUrl:"https://www.shutterstock.com/image-photo/whitetailed-jackrabbit-hopping-through-flowery-260nw-2482127681.jpg" },
  ]},
  { id:"set4-actions-and-family", name:"Actions and Family", items:[
    { words:["hugging","mommy"],    photoUrl:"https://thumbs.dreamstime.com/b/love-family-people-concept-happy-mother-child-daughter-hugging-home-116698410.jpg" },
    { words:["playing","daddy"],    photoUrl:"https://www.shutterstock.com/image-photo/father-child-boy-sitting-on-600nw-2658023065.jpg" },
    { words:["loving","baby"],      photoUrl:"https://thumbs.dreamstime.com/b/love-mother-baby-family-home-lifestyle-163820144.jpg" },
    { words:["laughing","sister"],  photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwivEAM-0CAAryRffMl0GyYWPOUUji1K7AZg&s" },
    { words:["helping","brother"],  photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQq4uvhcWteA6XHdbNWAGjUdLN6XVB01pe6Gg&s" },
  ]},
  { id:"set5-colors-and-motor-vehicle", name:"Colors and Motor Vehicles", items:[
    { words:["red","car"],       photoUrl:"https://www.shutterstock.com/image-illustration/red-sedan-car-on-white-260nw-2349354295.jpg" },
    { words:["yellow","bus"],    photoUrl:"https://media.istockphoto.com/id/472064524/photo/school-bus-on-blacktop-with-clean-sunny-background.jpg?s=612x612&w=0&k=20&c=lrB-9zXK1FJrM8nU7p1_2zQIbWJ5Aq6zoauS-YHQs8s=" },
    { words:["blue","bike"],     photoUrl:"https://www.shutterstock.com/image-photo/professional-studio-shot-sleek-blue-600nw-2672857605.jpg" },
    { words:["black","truck"],   photoUrl:"https://thumbs.dreamstime.com/b/black-pickup-truck-drives-open-highway-powerful-vehicle-moves-along-road-rear-view-driving-motion-blur-453675399.jpg" },
    { words:["green","scooter"], photoUrl:"https://www.shutterstock.com/image-photo/green-scooter-isolated-on-white-260nw-2573955103.jpg" },
  ]},
  { id:"set6-descriptive-toys", name:"Descriptive Toys", items:[
    { words:["soft","teddy"],       photoUrl:"https://media.istockphoto.com/id/2211906371/photo/isolated-soft-brown-teddy-bear-toy-for-comfort.jpg?s=612x612&w=0&k=20&c=N7pp010WlTSjUX1_wXxBVEyKq_RGf-Uu5bBaeDCOiSc=" },
    { words:["loud","drum"],        photoUrl:"https://media.istockphoto.com/id/682697316/photo/little-boy-playing-drums.jpg?s=612x612&w=0&k=20&c=O_HD7M1LmI2ESGI8BWlbfPUMFj9uyZDfiw9_M0XjEIY=" },
    { words:["colorful","block"],   photoUrl:"https://media.istockphoto.com/id/483876139/photo/toy-wooden-blocks-multicolor-building-construction-bricks.jpg?s=612x612&w=0&k=20&c=2RIgA7dCroAh6QbrFA6o0cDU-9sTwgRfswoEf5-cskg=" },
    { words:["bouncy","ball"],      photoUrl:"https://media.istockphoto.com/id/466335022/photo/space-hopper-challenge.jpg?s=612x612&w=0&k=20&c=nEqdwhaLdW7FU3l1nDi5jvCIH8pWHj94zKiBrsXuB68=" },
    { words:["fun","doll"],         photoUrl:"https://st3.depositphotos.com/5483844/17123/i/450/depositphotos_171235316-stock-photo-sit-and-smiling-cute-rag.jpg" },
  ]},
  { id:"set7-emotions-and-animals", name:"Emotions and Animals", items:[
    { words:["happy","dog"],     photoUrl:"https://cdn.create.vista.com/api/media/small/10214337/stock-photo-yellow-lab-puppy-in-the-yard" },
    { words:["scared","cat"],    photoUrl:"https://www.shutterstock.com/image-photo/very-unhappy-cat-arches-back-260nw-2604575379.jpg" },
    { words:["angry","lion"],    photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/050/063/452/small/a-lion-roaring-in-the-snow-photo.jpeg" },
    { words:["calm","fish"],     photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/068/356/349/small/colorful-betta-fish-swimming-gracefully-a-vibrant-betta-fish-moves-elegantly-through-the-water-showcasing-striking-orange-and-blue-colors-in-a-calm-setting-photo.jpg" },
    { words:["playful","puppy"], photoUrl:"https://media.istockphoto.com/id/1173036056/photo/smiling-puppy-dog.jpg?s=612x612&w=0&k=20&c=Z83O-MT6cGrHalL1D2dWOfw24JCiooXbkP09U045LT8=" },
  ]},
  { id:"set8-colors-and-household-obj", name:"Colors and Household Objects", items:[
    { words:["blue","cup"],     photoUrl:"https://www.shutterstock.com/image-photo/studio-photo-blue-mug-isolated-600nw-2340355509.jpg" },
    { words:["red","bowl"],     photoUrl:"https://media.istockphoto.com/id/1209049436/photo/empty-red-bowl-on-white-background.jpg?s=612x612&w=0&k=20&c=IqpsvS8_mpIU6KQ_07c-bZxZWDa79Hu2s4-hW5CTrzw=" },
    { words:["white","plate"],  photoUrl:"https://media.istockphoto.com/id/184276935/photo/empty-plate-on-white.jpg?s=612x612&w=0&k=20&c=ZRYlQdMJIfjoXbbPzygVkg8Hb9uYSDeEpY7dMdoMtdQ=" },
    { words:["yellow","spoon"], photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/075/759/124/small/shiny-golden-spoon-elegant-kitchen-utensil-culinary-cooking-eating-silverware-equipment-vector.jpg" },
    { words:["green","fork"],   photoUrl:"https://thumbs.dreamstime.com/b/green-fork-cutlery-tool-icon-green-fork-cutlery-tool-icon-vector-illustration-design-189699617.jpg" },
  ]},
  { id:"set9-descriptive-electronics", name:"Descriptive Electronics", items:[
    { words:["bright","phone"],  photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQi4N45ypef5Jak0dv6ZcTjDawP98o2PrbEGw&s" },
    { words:["loud","tv"],       photoUrl:"https://media.istockphoto.com/id/1460848181/photo/black-couple-watches-professional-soccer-match-on-tv-sitting-on-a-couch-at-home-in-the.jpg?s=612x612&w=0&k=20&c=ywSOwoggzBM3HkSvH-o8hH2UrMqUd3ADJBCRBQq3FhM=" },
    { words:["smart","tablet"],  photoUrl:"https://thumbs.dreamstime.com/b/woman-using-smart-home-system-digital-tablet-close-up-88093660.jpg" },
    { words:["fast","laptop"],   photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAvulqFl8MPGoS1SjjpMU5BKT3AcKFWtlJyw&s" },
    { words:["new","camera"],    photoUrl:"https://media.istockphoto.com/id/176963766/photo/dslr-camera-top-view.jpg?s=612x612&w=0&k=20&c=EjiZbZNBhrU-QoApuj_YCfmwZL0LUCv4_gYeToTq8AA=" },
  ]},
  { id:"set10-colors-and-animals", name:"Colors and Animals", items:[
    { words:["brown","bear"],     photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmh47wc3hZ8tX5dZPPlB87c8Vkv11W7UNVGg&s" },
    { words:["white","rabbit"],   photoUrl:"https://media.istockphoto.com/id/2069129839/photo/close-up-of-a-white-domestic-rabbit.jpg?s=612x612&w=0&k=20&c=wSzw6Ugt5AdmR5PZqCxXRf3XsdMzeaJhykbVd-eI9fA=" },
    { words:["black","panther"],  photoUrl:"https://www.shutterstock.com/image-photo/elegant-agile-panther-prowling-through-600nw-2500068041.jpg" },
    { words:["gray","wolf"],      photoUrl:"https://media.istockphoto.com/id/177794699/photo/grey-wolf-portrait.jpg?s=612x612&w=0&k=20&c=vEUo0UKAKeCIIm35zU0zR7XDOf-4AKXvJWLZGx4BVws=" },
    { words:["pink","pig"],       photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/047/538/103/small/adorable-piglet-in-a-sunny-pasture-free-photo.jpg" },
  ]},
  ...
  { id:"set12-descriptive-food", name:"Descriptive Food", items:[
    { words:["sweet","cake"],      photoUrl:"https://media.istockphoto.com/id/497959594/photo/fresh-cakes.jpg?s=612x612&w=0&k=20&c=T1vp7QPbg6BY3GE-qwg-i_SqVpstyHBMIwnGakdTTek=" },
    { words:["sour","lemon"],      photoUrl:"https://media.istockphoto.com/id/1142167442/photo/lemons-isolated-on-white-background.jpg?s=612x612&w=0&k=20&c=q8GDq2L2qkJ0SN3PmHEMeGGkjo-gj3pN0StZSKL9gjE=" },
    { words:["salty","chip"],      photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxo0SJY1bjxy_nPpi36kfZWR5itgizBXPXjg&s" },
    { words:["spicy","pepper"],    photoUrl:"https://www.shutterstock.com/image-photo/group-hot-chili-peppers-different-600nw-2710319783.jpg" },
    { words:["crunchy","cookie"],  photoUrl:"https://thumbs.dreamstime.com/b/chocolate-chip-cookie-white-clipping-path-12195349.jpg" },
  ]},
  { id:"set13-actions", name:"Actions", items:[
    { words:["eating","breakfast"], photoUrl:"https://www.shutterstock.com/image-photo/family-indoors-home-kitchen-counter-600nw-2450066511.jpg" },
    { words:["drinking","water"],   photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ57lPCGKkoMXtZcxGURUk-XQxCgxv2KCW2gA&s" },
    { words:["cooking","food"],     photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9B1xI2_oNz6oJIyAGDIx1T1YGyaJnrT8WOg&s" },
    { words:["baking","bread"],     photoUrl:"https://media.istockphoto.com/id/1370529871/photo/chefs-hands-spraying-flour-over-the-dough.jpg?s=612x612&w=0&k=20&c=X6XQjuwHHokbf3CLJh5e9k1x01VPGJb1Spbe3WcpKO4=" },
    { words:["serving","dinner"],   photoUrl:"https://www.shutterstock.com/image-photo/close-waiter-serving-food-during-260nw-2685181109.jpg" },
  ]},
  { id:"set14-actions-2", name:"Actions 2", items:[
    { words:["reading","book"],     photoUrl:"https://thumbs.dreamstime.com/b/child-school-library-kids-reading-books-read-little-boy-studying-children-book-store-smart-intelligent-preschool-kid-196109696.jpg" },
    { words:["writing","letter"],   photoUrl:"https://media.istockphoto.com/id/175384249/photo/writing-letter.jpg?s=612x612&w=0&k=20&c=StpznT-IidvGNGLsfNvdfJHXNmHDrqsaJ7rL9k4TYRc=" },
    { words:["drawing","picture"],  photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/072/324/769/small/artist-hand-sketching-a-detailed-woman-portrait-with-charcoal-on-white-paper-photo.jpg" },
    { words:["painting","canvas"],  photoUrl:"https://www.shutterstock.com/image-photo/group-friends-painting-colorful-abstract-260nw-2736797051.jpg" },
    { words:["singing","song"],     photoUrl:"https://www.shutterstock.com/image-photo/cute-chinese-little-girl-singing-260nw-2603311163.jpg" },
  ]},
  { id:"set15-instructions", name:"Instructions", items:[
    { words:["please","sit"],   photoUrl:"https://media.istockphoto.com/id/1138809673/photo/smiling-baby-sitting-on-bed.jpg?s=612x612&w=0&k=20&c=Xq0KEq1YuxnlZaZdqobYnq5_0_4RZnT_mzrxd-CWtcc=" },
    { words:["please","eat"],   photoUrl:"https://media.istockphoto.com/id/1365606385/photo/shot-of-a-baby-eating-a-meal-at-home.jpg?s=612x612&w=0&k=20&c=I7q4LGF-t9G9EEe7C5XmNwZT2oJ0UTe9AWEaXMxcKUE=" },
    { words:["please","stand"], photoUrl:"https://t4.ftcdn.net/jpg/04/22/99/97/360_F_422999766_DPgVOAXdhyVI9WhOBWfJLd8ImNxiuiXy.jpg" },
    { words:["please","sleep"], photoUrl:"https://www.shutterstock.com/image-photo/japanese-baby-boy-sleeping-luxury-600nw-2718939929.jpg" },
    { words:["please","wait"],  photoUrl:"https://thumbs.dreamstime.com/b/wait-sec-hold-perplexed-displeased-angry-redhead-serious-looking-girl-raising-palm-stop-prohibition-gesture-frowning-forbid-152490531.jpg" },
  ]},
  { id:"set16-different-juice", name:"Different Juice", items:[
    { words:["apple","juice"],   photoUrl:"https://media.istockphoto.com/id/503096289/photo/apple-juice-pouring-from-red-apples-into-a-glass.jpg?s=612x612&w=0&k=20&c=IUX6P386QI4V2641c8zYmnVl52nJMhhsCA2rUctHjqM=" },
    { words:["orange","juice"],  photoUrl:"https://media.istockphoto.com/id/1282705707/photo/delicious-freshly-squeezed-orange-juice-from-organic-oranges-from-the-own-tree.jpg?s=612x612&w=0&k=20&c=haJ4p6pjp_w5TTrFzHcP6O_4G8NrzN6f8F-ZW36SM-o=" },
    { words:["grape","juice"],   photoUrl:"https://media.istockphoto.com/id/171252820/photo/grape-juice.jpg?s=612x612&w=0&k=20&c=89XNYSxmQ5NER4GplazMFQTD0b5wE40qHcQCgN9pDKM=" },
    { words:["carrot","juice"],  photoUrl:"https://www.shutterstock.com/image-photo/carrot-juice-glass-fresh-carrots-600nw-2574735387.jpg" },
    { words:["tomato","juice"],  photoUrl:"https://www.shutterstock.com/image-photo/tomato-juice-glass-fresh-tomatoes-260nw-2680226847.jpg" },
  ]},
  { id:"set17-colors-and-food", name:"Colors and Food", items:[
    { words:["red","tomato"],       photoUrl:"https://www.shutterstock.com/image-photo/fresh-tomato-isolated-on-white-600nw-2724018559.jpg" },
    { words:["yellow","corn"],      photoUrl:"https://media.istockphoto.com/id/1403057876/photo/fresh-sweet-corn.jpg?s=612x612&w=0&k=20&c=vlB9zwWWUzlYOqVaWgxnkSy0fHqJyPwjY15THRhy5fM=" },
    { words:["green","broccoli"],   photoUrl:"https://thumbs.dreamstime.com/b/delicious-fresh-broccoli-delicious-fresh-broccoli-isolated-white-background-414967509.jpg" },
    { words:["orange","carrot"],    photoUrl:"https://thumbs.dreamstime.com/b/carrot-vegetable-leaves-isolated-white-background-cutout-89494831.jpg" },
    { words:["purple","eggplant"],  photoUrl:"https://www.shutterstock.com/image-photo/ripe-purple-eggplants-growing-on-260nw-2692217953.jpg" },
  ]},
  { id:"set18-actions-and-directions", name:"Actions and Directions", items:[
    { words:["go","up"],         photoUrl:"https://thumbs.dreamstime.com/b/joyful-kid-13615669.jpg" },
    { words:["look","down"],     photoUrl:"https://media.istockphoto.com/id/610678718/photo/youre-going-to-make-me-blush.jpg?s=612x612&w=0&k=20&c=gOIq802vkiVxjLwQN6dHQP9t2auER7gJrfddU8cx_K4=" },
    { words:["turn","left"],     photoUrl:"https://media.istockphoto.com/id/1179858968/vector/turn-left-traffic-sign-vector-illustration-traffic-road-sign.jpg?s=612x612&w=0&k=20&c=F-LWEJlLwdG6R3hkgLkh5PGHMrdrkkrOR5S0Ibel4nk=" },
    { words:["turn","right"],    photoUrl:"https://media.istockphoto.com/id/1179860629/vector/traffic-sign-turn-right-warning-attention-vector-on-yellow-background.jpg?s=612x612&w=0&k=20&c=wJZPwRe9BEg5_l3LWTI_4mBmYk6MHDxXpGoiFEMEDaE=" },
    { words:["move","forward"],  photoUrl:"https://www.shutterstock.com/image-photo/asphalt-road-white-arrow-sign-260nw-2277271951.jpg" },
  ]},
  { id:"set19-colors-and-electronics", name:"Colors and Electronics", items:[
    { words:["white","phone"],   photoUrl:"https://www.shutterstock.com/image-vector/smartphone-mockup-clay-outline-flat-260nw-2464849765.jpg" },
    { words:["black","tv"],      photoUrl:"https://www.shutterstock.com/image-photo/modern-tv-screen-hanging-on-600nw-2443243437.jpg" },
    { words:["silver","laptop"], photoUrl:"https://media.istockphoto.com/id/178083720/photo/a-laptop-open-against-a-white-background.jpg?s=612x612&w=0&k=20&c=9oSs_jN5ZJXHJbuLnpEyWuVlr1hkeQoWci1AUnH7fkA=" },
    { words:["red","camera"],    photoUrl:"https://www.shutterstock.com/image-photo/red-digital-camera-isolated-on-260nw-2638048619.jpg" },
    { words:["pink","tablet"],   photoUrl:"https://thumbs.dreamstime.com/b/realistic-pink-tablet-isometry-isolated-light-background-vector-illustration-80816468.jpg" },
  ]},
  { id:"set20-descriptive-fruit", name:"Descriptive Fruit", items:[
    { words:["ripe","banana"],       photoUrl:"https://www.shutterstock.com/image-photo/very-ripe-banana-on-white-260nw-2500493899.jpg" },
    { words:["fresh","apple"],       photoUrl:"https://media.istockphoto.com/id/489516086/photo/red-apple-fruit-with-drops-isolated-with-clipping-path.jpg?s=612x612&w=0&k=20&c=NVjViDfqhcJbLXvl3uGvGgj-yr3yCCz6O-tTAGMAGxI=" },
    { words:["juicy","orange"],      photoUrl:"https://media.istockphoto.com/id/174816200/photo/orange-juice.jpg?s=612x612&w=0&k=20&c=sqSSborE4XV3N5z7uyvowVKRbvhcH5nc518TZk97vXA=" },
    { words:["sweet","strawberry"],  photoUrl:"https://thumbs.dreamstime.com/b/close-up-fresh-ripe-strawberries-closeup-surface-sweet-background-red-berries-strawberry-macro-pattern-440432974.jpg" },
    { words:["perfect","peach"],     photoUrl:"https://thumbs.dreamstime.com/b/peach-slice-isolated-white-background-clipping-path-50380796.jpg" },
  ]},
  { id:"set21-descriptive-food-2", name:"Descriptive Food 2", items:[
    { words:["hot","soup"],          photoUrl:"https://media.istockphoto.com/id/1256537623/photo/eating-a-hot-pot-dish-with-chopsticks.jpg?s=612x612&w=0&k=20&c=ba7UDjNZ54lwJ3gWp3tqr8H2Tp86-QecVYRR9a1LUqU=" },
    { words:["cold","icecream"],     photoUrl:"https://www.shutterstock.com/image-photo/scooping-vanilla-ice-cream-plastic-600nw-2761979585.jpg" },
    { words:["warm","bread"],        photoUrl:"https://www.shutterstock.com/image-photo/baguette-steaming-on-dark-background-260nw-2598401063.jpg" },
    { words:["cool","salad"],        photoUrl:"https://media.istockphoto.com/id/1454741285/photo/roast-fish-and-vegetable-salad-on-wooden-background.jpg?s=612x612&w=0&k=20&c=Slmk-RLvdR3317E5W2UKLul4y1ZH3axjL2XCNOBZbhE=" },
    { words:["tasty","pasta"],       photoUrl:"https://www.shutterstock.com/image-photo/top-view-fettuccine-tomato-sauce-260nw-2714547941.jpg" },
  ]},
  { id:"set22-descriptive-places", name:"Descriptive Places", items:[
    { words:["quiet","library"],     photoUrl:"https://media.istockphoto.com/id/2222044555/photo/be-silent-gesture-hiding-behind-the-shelf-beautiful-woman-is-in-the-library.jpg?s=612x612&w=0&k=20&c=OX2bwFTeO5zns2bD-hOBeGBaHF3oUp7X60tobNXzJs8=" },
    { words:["busy","market"],       photoUrl:"https://thumbs.dreamstime.com/b/busy-market-chilpancingo-guerrero-mexico-photo-438161482.jpg" },
    { words:["fun","park"],          photoUrl:"https://thumbs.dreamstime.com/b/three-little-friends-kids-having-fun-roundabout-playground-55658569.jpg" },
    { words:["calm","beach"],        photoUrl:"https://media.istockphoto.com/id/622973040/photo/lanikai-beach-as-seen-from-above-in-kailua-oahu-hawaii.jpg?s=612x612&w=0&k=20&c=hibJymInyWcwZcXhcmI5-ZELaWicaDJrTAkWMpdiaTk=" },
    { words:["loud","stadium"],      photoUrl:"https://media.istockphoto.com/id/469569148/photo/soccer-fans-at-stadium.jpg?s=612x612&w=0&k=20&c=onoPfo3cZe9fH_F_9lXB1d1n3w2HGs2o6640lC-OFZg=" },
  ]},
  { id:"set23-colors-and-berries", name:"Colors and Berries", items:[
    { words:["red","strawberry"],     photoUrl:"https://www.shutterstock.com/image-photo/strawberries-slice-whole-on-white-260nw-2426201425.jpg" },
    { words:["blue","blueberry"],     photoUrl:"https://www.shutterstock.com/image-photo/blueberries-isolated-on-white-background-600nw-2604133331.jpg" },
    { words:["black","blackberry"],   photoUrl:"https://media.istockphoto.com/id/1188628278/photo/blackberry-with-leaf-isolated-on-a-white-background-closeup.jpg?s=612x612&w=0&k=20&c=G-Fxor7hQAMe7Eoa6h4W3Xm6Al6tc3mLon0EgKacMWA=" },
    { words:["red","cranberry"],      photoUrl:"https://www.shutterstock.com/image-photo/organic-raw-red-cranberries-bowl-260nw-2533663181.jpg" },
    { words:["yellow","gooseberry"],  photoUrl:"https://thumbs.dreamstime.com/b/cape-gooseberry-physalis-isolated-16026789.jpg" },
  ]},
  { id:"set24-places-and-furniture", name:"Places and Furniture", items:[
    { words:["kitchen","table"],     photoUrl:"https://www.shutterstock.com/image-illustration/3d-render-bright-modern-dining-260nw-2739134941.jpg" },
    { words:["bedroom","bed"],       photoUrl:"https://media.istockphoto.com/id/2208103079/photo/comfortable-large-bed-in-beautiful-room-interior-design.jpg?s=612x612&w=0&k=20&c=eonuYlkIFUg59bQU5qkunBthCTZ6RMCCNFNqPwc-Fo8=" },
    { words:["living room","sofa"],  photoUrl:"https://media.istockphoto.com/id/1311423416/photo/home-interior-background-with-green-sofa-table-and-decor-in-living-room.jpg?s=612x612&w=0&k=20&c=UhKDMvu4AxuoHkg2DcZSiy0ULIOnQhANfbtYkRTXvho=" },
    { words:["office","desk"],       photoUrl:"https://www.shutterstock.com/image-photo/contemporary-executive-office-setting-featuring-260nw-2738375617.jpg" },
    { words:["garden","bench"],      photoUrl:"https://media.istockphoto.com/id/1257928826/photo/wooden-garden-bench.jpg?s=612x612&w=0&k=20&c=hzUsaR2m6IEzmf4iQGwi99O4vAjeNC_F7g3bxpgIloQ=" },
  ]},
  // Set 25 — "chewing apple" → "biting an apple" (May 2026 content update,
  // matches the spreadsheet's clearer wording for the same concept).
  { id:"set25-eating-and-drinking", name:"Eating and Drinking", items:[
    { words:["eating","sandwich"],   photoUrl:"https://www.shutterstock.com/image-photo/cute-little-boy-eating-sandwich-600nw-2680056333.jpg" },
    { words:["drinking","milk"],     photoUrl:"https://www.shutterstock.com/image-photo/beautiful-young-woman-drinking-milk-600nw-2690842387.jpg" },
    { words:["tasting","soup"],      photoUrl:"https://thumbs.dreamstime.com/b/tasting-soup-handsome-young-man-pan-standing-kitchen-39771926.jpg" },
    { words:["biting","apple"],      photoUrl:"https://media.istockphoto.com/id/458047741/photo/biting-an-apple.jpg?s=612x612&w=0&k=20&c=mJ-QbnaedBnW8_-qwoDRE138l5BxWMN8-6ftcOZAzEQ=" },
    { words:["sipping","tea"],       photoUrl:"https://thumbs.dreamstime.com/b/hot-cup-tea-close-up-shot-young-girl-wearing-winter-clothes-drinking-isolated-white-background-45244038.jpg" },
  ]},
  { id:"set26-descriptive-places-2", name:"Descriptive Places 2", items:[
    { words:["cold","igloo"],        photoUrl:"https://thumbs.dreamstime.com/b/big-round-igloo-stands-mountains-covered-snow-marvelous-huge-white-snowy-hut-house-isolated-tourist-standing-88527203.jpg" },
    { words:["hot","desert"],        photoUrl:"https://media.istockphoto.com/id/469723319/photo/sunset-at-a-desert.jpg?s=612x612&w=0&k=20&c=uKgnUbvo-dCsHmBg8SBtGUTLXXQZlp0npd8hiNzZApE=" },
    { words:["wet","beach"],         photoUrl:"https://thumbs.dreamstime.com/b/getting-wet-3532177.jpg" },
    { words:["dry","mountain"],      photoUrl:"https://thumbs.dreamstime.com/b/view-dry-mountain-under-light-blue-sky-natural-landscape-difficult-roads-351281351.jpg" },
    { words:["green","forest"],      photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7S2Mr2gCil6Il85nwMRnHZQjEvfYx5v5O3g&s" },
  ]},
  { id:"set27-actions-and-directions-2", name:"Actions and Directions 2", items:[
    { words:["going","up"],          photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/002/554/140/small/statistics-chart-arrow-going-up-rising-food-prices-flat-style-icon-free-vector.jpg" },
    { words:["coming","down"],       photoUrl:"https://thumbs.dreamstime.com/b/graph-going-down-8261578.jpg" },
    { words:["walking","forward"],   photoUrl:"https://cdn.vectorstock.com/i/1000v/34/53/confident-man-walking-forward-vector-60703453.jpg" },
    { words:["running","back"],      photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/044/611/738/small/american-football-silhouette-isolated-on-white-background-american-football-logo-free-vector.jpg" },
    { words:["jumping","high"],      photoUrl:"https://thumbs.dreamstime.com/b/group-happy-kids-jump-high-over-sky-lawn-blue-stretched-lifted-hands-smiling-155920805.jpg" },
  ]},
  { id:"set28-colors-and-food-2", name:"Colors and Food 2", items:[
    { words:["white","rice"],        photoUrl:"https://thumbs.dreamstime.com/b/white-rice-1-2-1022788.jpg" },
    { words:["brown","bread"],       photoUrl:"https://www.shutterstock.com/image-photo/rye-bread-on-white-background-600nw-97547720.jpg" },
    { words:["yellow","cheese"],     photoUrl:"https://media.istockphoto.com/id/672526776/photo/cheddar-cheese-isolated-on-white-background.jpg?s=612x612&w=0&k=20&c=T6ykJOn4asR7Z21IG9D-ZdNUhEAHFW14lyqeq6a8io0=" },
    { words:["pink","ham"],          photoUrl:"https://media.istockphoto.com/id/144875599/photo/isolated-pink-ham-sliced-evenly.jpg?s=612x612&w=0&k=20&c=sUAyNESteNQNYfA93KNzQ8B_FiCVy23R4pvAh-hwOrg=" },
    { words:["green","lettuce"],     photoUrl:"https://thumbs.dreamstime.com/b/fresh-green-lettuce-white-background-top-view-isolated-romaine-454634261.jpg" },
  ]},
  { id:"set29-emotions-and-animals-2", name:"Emotions and Animals 2", items:[
    { words:["silly","monkey"],      photoUrl:"https://media.istockphoto.com/id/824860820/photo/barbary-macaque.jpg?s=612x612&w=0&k=20&c=n8oGBDq9oG90VPF6g-8ZS4tXaR5huTdRY4hUX2DjEkk=" },
    { words:["wise","owl"],          photoUrl:"https://thumbs.dreamstime.com/b/funny-owl-wearing-glasses-isolated-white-background-small-brown-looking-curious-round-black-447975018.jpg" },
    { words:["shy","turtle"],        photoUrl:"https://thumbs.dreamstime.com/b/shy-male-turtle-his-head-tucked-looking-directly-camera-late-afternoon-sunlight-box-nostrils-eyes-shiny-striped-438471236.jpg" },
    { words:["brave","lion"],        photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/057/843/124/small/a-lion-roaring-in-the-woods-photo.jpg" },
    { words:["gentle","lamb"],       photoUrl:"https://thumbs.dreamstime.com/b/cute-lamb-standing-white-background-adorable-looking-isolated-two-days-old-387809555.jpg" },
  ]},
  // Set 30 — fixed "trainplane" typo to "airplane" (May 2026 content update).
  { id:"set30-colors-and-transportatio", name:"Colors and Transportation", items:[
    { words:["red","firetruck"],     photoUrl:"https://media.istockphoto.com/id/89909590/photo/modern-red-fire-engine-truck-isolated-on-white-clipping-path.jpg?s=612x612&w=0&k=20&c=rCevbdxqq2VLRXP7GLMofkK9AN-QPKxvOshePL5pevg=" },
    { words:["yellow","schoolbus"],  photoUrl:"https://media.istockphoto.com/id/472064524/photo/school-bus-on-blacktop-with-clean-sunny-background.jpg?s=612x612&w=0&k=20&c=lrB-9zXK1FJrM8nU7p1_2zQIbWJ5Aq6zoauS-YHQs8s=" },
    { words:["blue","airplane"],     photoUrl:"https://thumbs.dreamstime.com/b/big-blue-passenger-plane-blue-sky-22529103.jpg" },
    { words:["white","boat"],        photoUrl:"https://thumbs.dreamstime.com/b/white-boat-sea-9758413.jpg" },
    { words:["black","limousine"],   photoUrl:"https://media.istockphoto.com/id/1171384158/photo/cadillac-escalade.jpg?s=612x612&w=0&k=20&c=xSXShMcyoH5u_MI_Qqvmm3eXznW38nO5Fjm5hKZ250Y=" },
  ]},
];

export const SENTENCES_MONTH3 = [
  { id:"set1-family-and-eating", name:"Family and Eating", items:[
    { sentence:"Mommy eats an apple.",     photoUrl:"https://thumbs.dreamstime.com/b/smiley-mother-her-eating-apple-daughter-26597669.jpg" },
    { sentence:"Daddy drinks water.",      photoUrl:"https://www.shutterstock.com/image-photo/father-daughter-drink-water-glasses-600nw-2526973239.jpg" },
    { sentence:"My sister cooks pasta.",   photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSX7HPPbRdwIzmA5da1wocBCFp_Bg8SYKgQbg&s" },
    { sentence:"My brother makes a cake.", photoUrl:"https://www.shutterstock.com/image-photo/top-back-view-shot-surprise-600nw-2650423205.jpg" },
    { sentence:"Baby tastes the milk.",    photoUrl:"https://media.istockphoto.com/id/170510614/photo/girl-drinking-glass-of-milk.jpg?s=612x612&w=0&k=20&c=Xeh0czTMTzeL6-DI_A6i5S4mElmqsEDUxEAaqXSGO38=" },
  ]},
  { id:"set2-family-and-emotions", name:"Family and Emotions", items:[
    { sentence:"Mommy feels happy.",       photoUrl:"https://www.shutterstock.com/image-photo/mom-daughter-car-feeling-happy-260nw-2667439453.jpg" },
    { sentence:"Daddy looks tired.",       photoUrl:"https://www.shutterstock.com/image-photo/stressed-tired-caucasian-father-close-600nw-2695198971.jpg" },
    { sentence:"My sister is excited.",    photoUrl:"https://media.istockphoto.com/id/638677204/photo/two-little-girl-at-music-school.jpg?s=612x612&w=0&k=20&c=G-jTnccajX9eEg8s3Qfkw8vlDbEodlc2rFL8EEY18U4=" },
    { sentence:"My brother is proud.",     photoUrl:"https://www.shutterstock.com/image-photo/child-wearing-red-tshirt-over-260nw-2254736145.jpg" },
    { sentence:"Baby is curious.",         photoUrl:"https://media.istockphoto.com/id/474206704/photo/watching-all-the-birdies-in-the-garden.jpg?s=612x612&w=0&k=20&c=xlNRy4KojxeFb1dG8c8zZpeOM9kGPJIgpViAZaJDXN0=" },
  ]},
  { id:"set3-animals-and-actions", name:"Animals and Actions", items:[
    { sentence:"The dog runs fast.",        photoUrl:"https://www.shutterstock.com/image-photo/dog-running-fast-on-field-600nw-2423586869.jpg" },
    { sentence:"The cat jumps high.",       photoUrl:"https://media.istockphoto.com/id/157590040/photo/domestic-cat-jumping.jpg?s=612x612&w=0&k=20&c=VQaMkU8Msdorqm3-AjtLW9TmX6w7U8qIJhrhosfFmAY=" },
    { sentence:"The bird flies away.",      photoUrl:"https://media.istockphoto.com/id/1306655815/vector/the-freedom-of-a-bird-leaving-its-cage.jpg?s=612x612&w=0&k=20&c=BHFDJcO239YTwD9asz6mdI9FevynEKaSbX5n5U9uJmY=" },
    { sentence:"The fish swims deep.",      photoUrl:"https://thumbs.dreamstime.com/b/large-vibrant-yellow-fish-blue-markings-swimming-deep-underwater-scene-lit-above-441901638.jpg" },
    { sentence:"The horse gallops quickly.",photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLR7VmjVPHXfx2_2qES7kfqjkVhM0_dgCqIA&s" },
  ]},
  { id:"set4-animals-and-size", name:"Animals and Size", items:[
    { sentence:"The elephant is huge.",     photoUrl:"https://thumbs.dreamstime.com/b/portrait-big-tusker-bull-elephant-24373505.jpg" },
    { sentence:"The mouse is tiny.",        photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/046/714/132/small/mouse-in-lush-green-grass-photo.jpg" },
    { sentence:"The giraffe is tall.",      photoUrl:"https://thumbs.dreamstime.com/b/tall-giraffe-near-trees-masai-mara-kenya-tall-giraffe-near-trees-masai-mara-kenya-430091269.jpg" },
    { sentence:"The penguin is small.",     photoUrl:"https://www.shutterstock.com/image-photo/cute-emperor-penguin-chick-walking-600nw-2706583819.jpg" },
    { sentence:"The whale is enormous.",    photoUrl:"https://cdn.pixabay.com/photo/2023/10/29/17/04/underwater-8350761_1280.jpg" },
  ]},
  { id:"set5-food-and-descriptions", name:"Food and Descriptions", items:[
    { sentence:"The soup is hot.",          photoUrl:"https://media.istockphoto.com/id/1226586928/photo/hot-vegetable-soup-in-a-dish-made-of-natural-materials-traditional-family-lunch-in-a-russian.jpg?s=612x612&w=0&k=20&c=BEJ-vSjbEpLWFUvgqVBuGlReQojVQC7zhAJI8c-YJQs=" },
    { sentence:"The ice cream is cold.",    photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/074/800/183/small/frozen-delight-in-a-bowl-a-still-life-of-chocolate-ice-cream-with-mint-garnish-photo.jpg" },
    { sentence:"The pizza is tasty.",       photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/048/958/329/small/tasty-pizza-margarita-with-tomatoes-and-cheese-on-wooden-board-closeup-fresh-cooked-food-photo.jpg" },
    { sentence:"The salad is fresh.",       photoUrl:"https://thumbs.dreamstime.com/b/fresh-salad-dish-30642637.jpg" },
    { sentence:"The cookie is sweet.",      photoUrl:"https://media.istockphoto.com/id/1939196650/photo/sweet-chocolate-cookies-on-plate-on-checkered-napkin.jpg?s=612x612&w=0&k=20&c=I5vSKAdAUSbvnvFpKwlY1vV0t-K3FaMhTVtGeppu-OI=" },
  ]},
  // Set 6 — "I love my home" intentionally has no photoUrl so it uses the
  // parent-uploaded home photo (or emoji fallback). Other 4 cards have stock.
  { id:"set6-favorite-locations", name:"Favorite Locations", items:[
    { sentence:"I love the park.",   photoUrl:"https://thumbs.dreamstime.com/b/playground-children-kids-play-equipment-outdoor-59299689.jpg" },
    { sentence:"I love the beach.",  photoUrl:"https://thumbs.dreamstime.com/b/tranquil-lanikai-beach-idyllic-hawaiian-paradise-white-sands-turquoise-waters-ai-generated-oahu-hawaii-322486683.jpg" },
    { sentence:"I love the zoo.",    photoUrl:"https://media.istockphoto.com/id/1483857371/photo/giraffe-and-zebra-at-north-carolina-zoo.jpg?s=612x612&w=0&k=20&c=LMi6Ftma02r3VHE5k371vG-DGZkWgiqAfNW0HI_BCD4=" },
    { sentence:"I love my home." }, // uses parent-uploaded home photo
    { sentence:"I love the garden.",photoUrl:"https://www.shutterstock.com/image-photo/farmer-hands-gloves-holding-bunch-260nw-2474886725.jpg" },
  ]},
  // Set 7 — replaced May 2026 with more interesting fruits + leek for variety
  { id:"set7-foods-and-colors", name:"Foods and Colors", items:[
    { sentence:"The dragonfruit is pink.", photoUrl:"https://www.shutterstock.com/image-photo/premium-dragon-fruit-isolated-on-600nw-2758771667.jpg" },
    { sentence:"The starfruit is yellow.", photoUrl:"https://www.shutterstock.com/image-photo/starfruits-isolated-on-white-backgroundwith-260nw-2735049795.jpg" },
    { sentence:"The mango is green.",      photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/052/782/650/small/fresh-green-mango-fruit-with-slice-and-leaf-on-transparent-background-free-png.png" },
    { sentence:"The leek is green.",       photoUrl:"https://media.istockphoto.com/id/689792314/photo/leek-cut-into-pieces-on-an-old-wooden-table.jpg?s=612x612&w=0&k=20&c=c-NtgH5orLLEz1s2EdjqcZa-T3BwSZH1CI9BmoK1iYA=" },
    { sentence:"The carrot is purple.",    photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpejVfdU6PJfVmOCK_UDlydRr0CDkFM_p3ww&s" },
  ]},
  { id:"set8-animals-and-colors", name:"Animals and Colors", items:[
    { sentence:"The bear is brown.",   photoUrl:"https://upload.wikimedia.org/wikipedia/commons/7/71/2010-kodiak-bear-1.jpg" },
    { sentence:"The swan is white.",   photoUrl:"https://images.unsplash.com/photo-1593069310094-080326c950a1?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d2hpdGUlMjBzd2FufGVufDB8fDB8fHww" },
    { sentence:"The crow is black.",   photoUrl:"https://upload.wikimedia.org/wikipedia/commons/a/a9/Corvus_corone_-near_Canford_Cliffs%2C_Poole%2C_England-8.jpg" },
    { sentence:"The lion is golden.",  photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/049/874/423/small/image-of-a-golden-lion-photo.jpeg" },
    { sentence:"The frog is green.",   photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNiXWLTqC1FAC0fErb7CHmnYCZCRahNmK6Dw&s" },
  ]},
  { id:"set9-vegetables-and-colors", name:"Vegetables and Colors", items:[
    { sentence:"The tomato is red.",     photoUrl:"https://upload.wikimedia.org/wikipedia/commons/8/89/Tomato_je.jpg" },
    { sentence:"The corn is yellow.",    photoUrl:"https://www.shutterstock.com/image-photo/peeled-sweet-corn-cobs-farmers-260nw-2494740117.jpg" },
    { sentence:"The eggplant is purple.",photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/023/806/188/small/a-purple-eggplant-with-a-green-stem-generative-ai-generated-photo.jpg" },
    { sentence:"The spinach is green.",  photoUrl:"https://media.istockphoto.com/id/1006196472/photo/bunch-of-spinach-leaves-on-isolated-white-background.jpg?s=612x612&w=0&k=20&c=OAIswtUC1aMNDwtMEFIaZv6fSIftsoAV-cgJZSGLJ7A=" },
    { sentence:"The carrot is orange.",  photoUrl:"https://media.istockphoto.com/id/619252960/photo/carrot.jpg?s=612x612&w=0&k=20&c=C-PlZ2oHW2SDCkaZXn8rg1UFdeF5ismwiy3v7uQRVKE=" },
  ]},
  // Set 10 — family items use parent's uploaded photos / kinship emoji
  ...
  { id:"set11-locations-and-colors", name:"Locations and Colors", items:[
    { sentence:"The sky is blue.",      photoUrl:"https://www.shutterstock.com/image-photo/clear-blue-sky-few-clouds-600nw-2488278533.jpg" },
    { sentence:"The grass is green.",   photoUrl:"https://images.pexels.com/photos/580900/pexels-photo-580900.jpeg?cs=srgb&dl=pexels-mattycphoto-580900.jpg&fm=jpg" },
    { sentence:"The sand is yellow.",   photoUrl:"https://media.istockphoto.com/id/156530984/photo/sand-dunes-at-sunrise.jpg?s=612x612&w=0&k=20&c=oVm3TEqJMhFqwig38HxEaxBQ8_fDTlo0-xP6ef96r1s=" },
    { sentence:"The snow is white.",    photoUrl:"https://media.istockphoto.com/id/455011625/photo/panorama-of-the-foggy-winter-mountains.jpg?s=612x612&w=0&k=20&c=hj6rK1IBXTGSisfkY9n6hurWWaXdQVQyEHNCUEDlB0g=" },
    { sentence:"The soil is brown.",    photoUrl:"https://www.shutterstock.com/image-photo/path-covered-mulch-selective-focus-260nw-2760737899.jpg" },
  ]},
  // Set 12 — "I love" sentences use family photos / home photo / avatar
  ...
  { id:"set13-family-and-actions", name:"Family and Actions", items:[
    { sentence:"Mommy hugs the baby.",         photoUrl:"https://www.shutterstock.com/image-photo/young-asian-mother-baby-600nw-2655554223.jpg" },
    { sentence:"Daddy kisses my sister.",      photoUrl:"https://thumbs.dreamstime.com/b/young-father-his-cute-little-daughter-home-kissing-him-nose-92540206.jpg" },
    { sentence:"My brother plays ball.",       photoUrl:"https://www.shutterstock.com/image-photo/boy-kid-playing-football-park-600nw-2463593175.jpg" },
    { sentence:"My sister reads a book.",      photoUrl:"https://thumbs.dreamstime.com/b/sister-girls-read-book-lovely-little-reading-concept-education-family-people-isolated-white-background-112527907.jpg" },
    { sentence:"Baby laughs happily.",         photoUrl:"https://media.istockphoto.com/id/165945036/photo/happy-laughing-baby-boy-lying-on-textured-fabric.jpg?s=612x612&w=0&k=20&c=Cdl3Tb7txPAdZL724g_yj_PQl25TnrRqi41Y6zMHw0c=" },
  ]},
  { id:"set14-animals-and-actions-2", name:"Animals and Actions 2", items:[
    { sentence:"The dog wags its tail.",   photoUrl:"https://www.shutterstock.com/image-vector/adorable-dog-wagging-tail-happiness-600nw-2504537337.jpg" },
    { sentence:"The cat purrs softly.",    photoUrl:"https://www.shutterstock.com/image-photo/human-fingers-gently-caressing-snowwhite-260nw-2620509109.jpg" },
    { sentence:"The bird sings sweetly.",  photoUrl:"https://www.shutterstock.com/image-vector/cheerful-blue-bird-sings-sweet-260nw-2676989399.jpg" },
    { sentence:"The fish splashes water.", photoUrl:"https://media.istockphoto.com/id/108272184/photo/small-fish-jumping-out-of-water.jpg?s=612x612&w=0&k=20&c=lEu9ExEDvoKh_YuOGl3OGTRTinHIltp5FOms2ZgZtE0=" },
    { sentence:"The rabbit hops gently.",  photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/054/587/063/small/energetic-rabbit-hopping-with-ears-upright-across-golden-field-in-autumn-nature-wildlifegraphy-showing-motion-and-serenity-for-seasonal-stock-use-photo.jpeg" },
  ]},
  { id:"set15-animals-and-emotions", name:"Animals and Emotions", items:[
    { sentence:"The dog feels happy.",     photoUrl:"https://media.istockphoto.com/id/1503385646/photo/portrait-funny-and-happy-shiba-inu-puppy-dog-peeking-out-from-behind-a-blue-banner-isolated.jpg?s=612x612&w=0&k=20&c=xZq8PhunL9ZmY243et3GOf04wJPBmHzeiQ3jw7nWCrY=" },
    { sentence:"The cat feels calm.",      photoUrl:"https://thumbs.dreamstime.com/b/rooftop-zen-closing-my-eyes-feeling-gentle-breeze-there-nothing-like-finding-quiet-spot-above-world-to-just-relax-421652192.jpg" },
    { sentence:"The bird feels free.",     photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRanCYVByPSdc2oYzA7GvWwizrcLxg4hu_GSQ&s" },
    { sentence:"The fish feels peaceful.", photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROku3Pt-NmlHdcSFB8_WiSEb05my8yeqDhng&s" },
    { sentence:"The puppy feels playful.", photoUrl:"https://www.shutterstock.com/image-photo/playful-happy-active-small-terrier-260nw-2542885003.jpg" },
  ]},
  { id:"set16-occupations-and-actions", name:"Occupations and Actions", items:[
    { sentence:"The doctor helps people.",       photoUrl:"https://thumbs.dreamstime.com/b/emergency-room-doctors-helping-woman-stifneck-two-women-58606335.jpg" },
    { sentence:"The teacher teaches students.",  photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_w0b13sdo9r3-sxU0j6pcPbN1UZ29ftQYzA&s" },
    { sentence:"The chef cooks food.",           photoUrl:"https://thumbs.dreamstime.com/b/female-chef-restaurant-hotel-kitchen-cooki-20720964.jpg" },
    { sentence:"The firefighter puts out fires.",photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKwX8LWCSqdymNONtr9sFzTzIChrhfwzl5mA&s" },
    { sentence:"The artist paints pictures.",    photoUrl:"https://media.istockphoto.com/id/1254268298/photo/female-painter-painting-on-lavender-field-in-sunset.jpg?s=612x612&w=0&k=20&c=HC94USXiGAS7ChQlV0smTFInmor0WaIQGg-XmI9simo=" },
  ]},
  ...
  { id:"set18-directions", name:"Directions", items:[
    { sentence:"Go up the stairs.",   photoUrl:"https://t4.ftcdn.net/jpg/02/94/73/65/360_F_294736560_2PRHqSr8wF6KxE1JpeQycKcpbPCCLI9E.jpg" },
    { sentence:"Go down the slide.",  photoUrl:"https://thumbs.dreamstime.com/b/free-play-playground-baby-toddler-important-activity-child-development-asian-baby-girl-going-down-109272749.jpg" },
    { sentence:"Turn left here.",     photoUrl:"https://media.istockphoto.com/id/1161407829/vector/turn-left-traffic-road-sign-isolate-on-white-background-vector-illustration-eps-10.jpg?s=612x612&w=0&k=20&c=ro32dD_t4YBwAJUxYYWGW4jI790eHvCEyDNcQtDxRIc=" },
    { sentence:"Turn right there.",   photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/003/611/866/small_2x/turn-right-traffic-road-sign-isolate-on-white-background-illustration-eps-10-free-vector.jpg" },
    { sentence:"She walks away.",     photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeeU9Nlq6-Q9V8Oq2JLZCuS3mK4STuR7xkZyDcR8RZXVZi3ZIKng0TzkOO&s=10" },
  ]},
  { id:"set19-occupations-and-emotions", name:"Occupations and Emotions", items:[
    { sentence:"The doctor feels caring.",    photoUrl:"https://img.magnific.com/free-photo/doctor-are-well-good-taken-care-elderly-patients-hospital-bed-patients-feel-happiness-medical-healthcare-concept_1150-21713.jpg" },
    { sentence:"The teacher feels proud.",    photoUrl:"https://media.istockphoto.com/id/2202092228/photo/elementary-school-teacher-at-front-of-class-smiling-with-hands-on-chest-gratitude-emotion.jpg?s=612x612&w=0&k=20&c=LXpBtPl8XTuaYrEIDbHzgeufa1dD2EDq1OQdgSrhQFs=" },
    { sentence:"The chef feels creative.",    photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/054/645/827/small/a-male-chef-is-preparing-food-on-a-plate-photo.jpg" },
    { sentence:"The artist feels inspired.",  photoUrl:"https://thumbs.dreamstime.com/b/curly-red-haired-artist-feeling-inspired-coloring-picture-true-inspiration-curly-red-haired-artist-feeling-inspired-150273900.jpg" },
    { sentence:"The musician feels joyful.",  photoUrl:"https://images.stockcake.com/public/c/8/a/c8a92f2c-70b8-4226-b94e-fb2281246a55_large/joyful-street-musician-stockcake.jpg" },
  ]},
  { id:"set20-parts-of-the-face", name:"Parts of the Face", items:[
    { sentence:"Eyes can see.",        photoUrl:"https://www.shutterstock.com/image-photo/young-man-brown-eyes-closeup-260nw-2672667333.jpg" },
    { sentence:"A nose can smell.",    photoUrl:"https://thumbs.dreamstime.com/b/nose-isolated-white-nose-isolated-white-background-102612546.jpg" },
    { sentence:"Ears can hear.",       photoUrl:"https://www.shutterstock.com/image-photo/close-womans-ear-brown-hair-260nw-2508219047.jpg" },
    { sentence:"A mouth can taste.",   photoUrl:"https://media.istockphoto.com/id/901170274/photo/babys-mouth.jpg?s=612x612&w=0&k=20&c=W6pLKQVfx_DX2ffn5rqvSQNuRj4PkcA75d3v3Ohidjs=" },
    { sentence:"Skin can feel.",       photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/072/115/741/small/close-up-detailed-macro-texture-of-human-skin-a-natural-pattern-for-medical-and-beauty-concepts-photo.jpg" },
  ]},
  { id:"set21-body-parts", name:"Body Parts", items:[
    { sentence:"Arms can hug.",        photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ03U0k_1doWf8zuWelxBcPPFFIZKPiZcWCTwT_OuPvUpetK1UeiE8NfCyF&s=10" },
    { sentence:"Legs can run.",        photoUrl:"https://media.istockphoto.com/id/607741774/photo/little-girl-run-through-the-park.jpg?s=612x612&w=0&k=20&c=FDTlrn2jewvAULtAuTAZZydbqZjYG_0BOslNtdyt8l0=" },
    { sentence:"Hands can clap.",      photoUrl:"https://static.vecteezy.com/system/resources/thumbnails/065/706/672/small/a-young-child-is-standing-with-his-hands-up-photo.jpeg" },
    { sentence:"Feet can stomp.",      photoUrl:"https://thumbs.dreamstime.com/b/little-kid-gray-suit-snowflakes-print-boots-smiling-stomping-floor-isolated-white-background-christmas-new-176478509.jpg" },
    { sentence:"A heart can love.",    photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnQR-VOvqXv1cNTPpLqCNlG5ox_7gw5nGk7OIEEKmTi7eFxVowoIhLSJMN&s=10" },
  ]},
  { id:"set22-playing-sports", name:"Playing Sports", items:[
    { sentence:"We play soccer.",      photoUrl:"https://images.stockcake.com/public/f/1/1/f112aab3-e5db-4835-a02e-ab5d315173ec_large/kids-playing-soccer-stockcake.jpg" },
    { sentence:"We play basketball.",  photoUrl:"https://media.istockphoto.com/id/1441726685/photo/we-love-basketball.jpg?s=612x612&w=0&k=20&c=xkZj9yqv-rEqzBysRPfXpM0fe1FUxDfadN5NypVocz8=" },
    { sentence:"We play tennis.",      photoUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPwF8auXgKxXPgw7tl5RaGAzT-3a_xhgeJSHSodXVdAA&s" },
    { sentence:"We play baseball.",    photoUrl:"https://www.shutterstock.com/image-photo/outdoor-photo-play-on-baseball-260nw-2671471601.jpg" },
    { sentence:"We play volleyball.",  photoUrl:"https://images.pexels.com/photos/6203521/pexels-photo-6203521.jpeg" },
  ]},
  { id:"set23-favorite-foods", name:"Favorite Foods", items:[
    { sentence:"My favorite is apple.",      photoUrl:"https://media.istockphoto.com/id/95761550/photo/professional-photograph-of-a-green-apple.jpg?s=612x612&w=0&k=20&c=bgmacIRnZ7skrpJgBOQ-sF4SQZ_nHUKs9MjT73jC05g=" },
    { sentence:"My favorite is pasta.",      photoUrl:"https://media.istockphoto.com/id/155433174/photo/bolognese-pens.jpg?s=612x612&w=0&k=20&c=A_TBqOAzcOkKbeVv8qSDs0bukfAedhkA458JEFolo_M=" },
    { sentence:"My favorite is pizza.",      photoUrl:"https://upload.wikimedia.org/wikipedia/commons/9/91/Pizza-3007395.jpg" },
    { sentence:"My favorite is ice cream.",  photoUrl:"https://upload.wikimedia.org/wikipedia/commons/2/2e/Ice_cream_with_whipped_cream%2C_chocolate_syrup%2C_and_a_wafer_%28cropped%29.jpg" },
    { sentence:"My favorite is bread.",      photoUrl:"https://cdn.pixabay.com/photo/2025/10/01/01/13/sourdough-9865309_1280.jpg" },
  ]},
  { id:"set24-superhero-sentences", name:"Superhero Sentences", items:[
    { sentence:"Superman flies high.",      photoUrl:"https://www.shutterstock.com/image-photo/superman-flies-over-san-francisco-260nw-2748416993.jpg" },
    { sentence:"Batman is brave.",          photoUrl:"https://w0.peakpx.com/wallpaper/373/795/HD-wallpaper-batman-by-datrinti-bat-robert-pattinson-the-batman.jpg" },
    { sentence:"Spiderman climbs walls.",   photoUrl:"https://thumbs.dreamstime.com/b/spider-man-climbing-wall-d-coming-out-video-clip-spiderman-superhero-128819234.jpg" },
    { sentence:"Hulk is strong.",           photoUrl:"https://www.shutterstock.com/image-photo/incredible-hulk-isolated-comic-book-260nw-2712493969.jpg" },
    { sentence:"Wonderwoman saves people.", photoUrl:"https://sixoh6.com/wp-content/uploads/2017/06/0c323cb1eb7267fee3bb8829fa1e36f9.jpg" },
  ]},
  { id:"set25-good-behavior", name:"Good Behavior", items:[
    { sentence:"We say please.",         photoUrl:"https://thumbs.dreamstime.com/b/please-kid-hand-sign-language-white-background-39995541.jpg" },
    { sentence:"We say thank you.",      photoUrl:"https://thumbs.dreamstime.com/b/thank-you-kid-hand-sign-language-white-background-39995485.jpg" },
    { sentence:"We share our toys.",     photoUrl:"https://thumbs.dreamstime.com/b/little-toddlers-boy-girl-playing-together-nursery-room-preschool-children-day-care-centre-play-147377839.jpg" },
    { sentence:"We help our friends.",   photoUrl:"https://thumbs.dreamstime.com/b/cute-little-toddler-boy-showing-friend-gesture-sign-language-gray-background-isolated-image-cute-little-toddler-boy-showing-241330249.jpg" },
    { sentence:"We are kind.",           photoUrl:"https://thumbs.dreamstime.com/b/cute-little-toddler-boy-showing-gesturfor-deaf-people-cute-little-toddler-boy-showing-gesture-sign-language-gray-background-241330259.jpg" },
  ]},
  ...
  // Set 28 — replaced May 2026 with kitchen/school/pool/room/market.
  // Card 4 "I love my room" intentionally has no photoUrl — uses parent-uploaded
  // photo of baby's room when available, else falls back to single-word lookup.
  { id:"set28-my-favorite-places", name:"My Favorite Places", items:[
    { sentence:"I love my kitchen.", photoUrl:"https://media.istockphoto.com/id/464426662/photo/a-child-playing-with-a-fake-kitchen.jpg?s=612x612&w=0&k=20&c=27V56Kt0PK48CltcYElH2SvWbJgRuDnPZVdzpzz4xGU=" },
    { sentence:"I love my school.",  photoUrl:"https://thumbs.dreamstime.com/b/clever-kids-student-group-school-classroom-20979839.jpg" },
    { sentence:"I love the pool.",   photoUrl:"https://thumbs.dreamstime.com/b/kids-swimming-pool-children-swim-family-fun-play-learn-to-outdoor-tropical-resort-summer-vacation-water-splash-172190426.jpg" },
    { sentence:"I love my room." },  // uses parent-uploaded baby's-room photo
    { sentence:"I love the market.", photoUrl:"https://media.istockphoto.com/id/1018114944/photo/smiling-african-american-kid-sitting-in-shopping-trolley-with-pineapple-in-grocery-store.jpg?s=612x612&w=0&k=20&c=LwDHtR27K1dVpWYI1gUH_EavUtdCfvUKHYl6fqaOC1M=" },
  ]},
...
export const KNOWLEDGE_MONTH3 = [
  // ── Set 1: European Countries ──
  // 5 maps. Facts are short and concrete: location, capital, language.
  { id:"kset1-european-countries", name:"European Countries", items:[
    { id:"france_map", photoSeed:"france_map", facts:[
      "France is in Europe.",
      "Paris is the capital of France.",
      "People speak French in France.",
    ]},
    { id:"germany_map", photoSeed:"germany_map", facts:[
      "Germany is in Europe.",
      "Berlin is the capital of Germany.",
      "People speak German in Germany.",
    ]},
    { id:"italy_map", photoSeed:"italy_map", facts:[
      "Italy is shaped like a boot.",
      "Rome is the capital of Italy.",
      "People speak Italian in Italy.",
    ]},
    { id:"spain_map", photoSeed:"spain_map", facts:[
      "Spain is in Europe.",
      "Madrid is the capital of Spain.",
      "People speak Spanish in Spain.",
    ]},
    { id:"uk_map", photoSeed:"uk_map", facts:[
      "The UK is in Europe.",
      "London is the capital of the UK.",
      "People speak English in the UK.",
    ]},
  ]},
  // ── Set 2: Sports ──
  // Card 2 changed from boxing → figure_skating.
  { id:"kset2-sports", name:"Sports", items:[
    { id:"hockey", photoSeed:"hockey", facts:[
      "Hockey is played on ice.",
      "Players use a stick and puck.",
      "The puck slides on the ice.",
    ]},
    { id:"figure_skating", photoSeed:"figure_skating", facts:[
      "Figure skating is done on ice.",
      "Skaters spin and jump.",
      "Their skates have sharp blades.",
    ]},
    { id:"gymnastics", photoSeed:"gymnastics", facts:[
      "Gymnasts flip and tumble.",
      "They balance on a beam.",
      "Gymnastics needs strong muscles.",
    ]},
    { id:"skiing", photoSeed:"skiing", facts:[
      "Skiers slide down snowy mountains.",
      "They wear long skis on their feet.",
      "Skiing is a winter sport.",
    ]},
    { id:"cycling", photoSeed:"cycling", facts:[
  ...
  // ── Set 3: Types of Cars ──
  // Total replacement: brand-name cars (Ferrari, Tesla, etc.) → category types.
  // Card IDs use snake_case for code, display names handled by KNOWLEDGE_TITLES.
  { id:"kset3-types-of-cars", name:"Types of Cars", items:[
    { id:"classic_car", photoSeed:"classic_car", facts:[
      "Classic cars are very old.",
      "They were built long ago.",
      "Many people collect classic cars.",
    ]},
    { id:"electric_car", photoSeed:"electric_car", facts:[
      "Electric cars run on batteries.",
      "They plug in to charge.",
      "Electric cars are very quiet.",
    ]},
    { id:"atv", photoSeed:"atv", facts:[
      "An ATV has four big wheels.",
      "It can drive on rough ground.",
      "ATV means all-terrain vehicle.",
    ]},
    { id:"race_car", photoSeed:"race_car", facts:[
      "Race cars go very fast.",
      "They race on a special track.",
      "Drivers wear helmets for safety.",
    ]},
    { id:"van", photoSeed:"van", facts:[
      "Vans are big and roomy.",
      "Many people fit inside a van.",
      "Vans can carry lots of things.",
    ]},
  ]},
  // ── Set 4: Flowers ──
  // Total replacement: rose/tulip/sunflower/orchid/daisy → hydrangea/babys_breath/hibiscus/orchid/peony.
  { id:"kset4-flowers", name:"Flowers", items:[
    { id:"hydrangea", photoSeed:"hydrangea", facts:[
      "Hydrangeas grow in big round clusters.",
      "They can be blue, pink, or white.",
      "Hydrangeas like lots of water.",
    ]},
    { id:"babys_breath", photoSeed:"babys_breath", facts:[
      "Baby's breath is small and white.",
      "Many tiny flowers grow on one stem.",
      "It is often used in bouquets.",
    ]},
    { id:"hibiscus", photoSeed:"hibiscus", facts:[
      "Hibiscus flowers are big and bright.",
      "They grow in warm, sunny places.",
      "Hummingbirds love hibiscus.",
    ]},
    { id:"orchid", photoSeed:"orchid", facts:[
      "Orchids come in many colors.",
      "They grow in jungles and forests.",
      "Orchids have very pretty shapes.",
    ]},
    { id:"peony", photoSeed:"peony", facts:[
      "Peonies have soft, fluffy petals.",
      "They smell sweet.",
      "Peonies bloom in late spring.",
    ]},
  ]},
  // ── Set 5: Canines ──
  // Cards 1-3 from spreadsheet (wolf, fox, coyote — facts updated). Cards 4-5
  // unchanged (jackal, dingo) since spreadsheet only listed first 3.
  { id:"kset5-canines", name:"Canines", items:[
    { id:"wolf", photoSeed:"wolf", facts:[
      "Wolves live in family groups called packs.",
      "Wolves howl to talk to each other.",
      "Dogs are related to wolves.",
    ]},
    { id:"fox", photoSeed:"fox", facts:[
      "Foxes have bushy tails.",
      "Foxes are clever hunters.",
      "Foxes live in dens.",
    ]},
    { id:"coyote", photoSeed:"coyote", facts:[
      "Coyotes look like small wolves.",
